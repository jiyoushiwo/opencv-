...
def roi_mask(gray_img):
    ...
    """
    poly_pts = np.array([[[300, 675], [556, 443], [903, 452], [1272, 671]]])
    # poly_pts = np.array([[[17,314],[412,40],[580,39],[806,325]]])
...
def draw_lines(img, lines):
    ...
    cv2.line(img, tuple(left_line[0]), tuple(left_line[1]), color=(0, 0, 255),
             thickness=5)
...
capture = cv2.VideoCapture(r'Input_Video.mp4')
